...
void SalpaParams::loadSettings(QSettings &settings) {
  ...
  trigger_device = settings.value("trigger_device", "").toString();
  trigger_line = settings.value("trigger_line", "").toString();
...
void SalpaParams::saveSettings(QSettings &settings) const {
  ...
  settings.setValue("trigger_device", trigger_device);
  settings.setValue("trigger_line", trigger_line);
